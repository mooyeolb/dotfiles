...
__conda_setup="$('/home/mooyeolb/.local/share/mambaforge/bin/conda' 'shell.zsh' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/home/mooyeolb/.local/share/mambaforge/etc/profile.d/conda.sh" ]; then
        . "/home/mooyeolb/.local/share/mambaforge/etc/profile.d/conda.sh"
    else
        export PATH="/home/mooyeolb/.local/share/mambaforge/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<
